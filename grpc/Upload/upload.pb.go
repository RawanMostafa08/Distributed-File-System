...
const file_upload_proto_rawDesc = "" +
	...
	"\x03end\x18\x04 \x01(\x03R\x03end2\xdd\x03\n" +
	"\x03DFS\x12F\n" +
	...
	"\x13DownloadFileRequest\x12\x1f.Upload.DownloadFileRequestBody\x1a .Upload.DownloadFileResponseBodyB\x03Z\x01/b\x06proto3"
